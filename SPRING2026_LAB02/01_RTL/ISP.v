...
reg [11:0] d1_reg5_0, d1_reg5_1, d1_reg5_2, d1_reg5_3;
reg [11:0] d2_reg5_0, d2_reg5_1, d2_reg5_2, d2_reg5_3;
reg [11:0] center_p_reg5;

always @(posedge clk or negedge rst_n) begin : DPC_stage5_to_6
    if(!rst_n) begin
        h_reg5_0 <= 0; h_reg5_1 <= 0; h_reg5_2 <= 0; h_reg5_3 <= 0;
        v_reg5_0 <= 0; v_reg5_1 <= 0; v_reg5_2 <= 0; v_reg5_3 <= 0;
        d1_reg5_0 <= 0; d1_reg5_1 <= 0; d1_reg5_2 <= 0; d1_reg5_3 <= 0;
        ...
        d2_reg5_0 <= DPC_WIN5X5[0][4]; d2_reg5_1 <= DPC_WIN5X5[1][3]; d2_reg5_2 <= DPC_WIN5X5[3][1]; d2_reg5_3 <= DPC_WIN5X5[4][0];
